...
const products = [
  { id: 1, name: "TShirt", price: "499.00 Rs", image: "https://via.placeholder.com/150" },
  { id: 1, name: "TShirt", price: "499.00 Rs", image: "https://via.placeholder.com/150" },
  { id: 1, name: "TShirt", price: "499.00 Rs", image: "https://via.placeholder.com/150" },
  { id: 1, name: "TShirt", price: "499.00 Rs", image: "https://via.placeholder.com/150" },
  { id: 1, name: "TShirt", price: "499.00 Rs", image: "https://via.placeholder.com/150" },
...
const TShirt = () => {
  return (
    <div className="min-h-screen p-6 flex flex-col items-center">
      <h1 className="text-4xl font-bold mb-6">Zenith's Best Collections Of <span className="text-blue-500">T-Shirt</span></h1>
